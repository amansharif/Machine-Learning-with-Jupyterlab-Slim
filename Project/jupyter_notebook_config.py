...
#  Default: ''
c.NotebookApp.password = u'argon2:$argon2id$v=19$m=10240,t=10,p=8$/Izr9RWZPlIqT2hNT7wEpA$SulKGXnH6SQfzJ9cVPr5fQ'
...
#  Choices: any of ['sha3_512', 'md5', 'blake2b', 'sha3_384', 'blake2s', 'sha3_224', 'sha256', 'sha1', 'sha224', 'sha512', 'sha384', 'sha3_256']
#  Default: 'sha256'
